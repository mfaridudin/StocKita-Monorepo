<aside class="h-screen w-64 bg-white border-r border-green-100 shadow-lg flex flex-col">
    ...
    <div class="p-6 border-b border-green-50">
        ...
        <p class="text-xs text-green-600 font-medium mt-1">Inventory Management</p>
    </div>
    ...
    <nav class="flex-1 px-4 py-6 space-y-1">
        ...
        <a href="/products" 
           class="nav-item {{ str_starts_with($currentPath, 'products') ? 'active' : '' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/warehouse" 
           class="nav-item {{ str_starts_with($currentPath, 'warehouse') ? 'active' : '' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/customers" 
           class="nav-item {{ str_starts_with($currentPath, 'customers') ? 'active' : '' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/reports" 
           class="nav-item {{ str_starts_with($currentPath, 'reports') ? 'active' : '' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
            </svg>
            Laporan
        ...
        <a href="/roles"
           class="nav-item {{ str_starts_with($currentPath, 'roles') ? 'active' : '' }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="p-4 border-t border-green-100 bg-green-50/50">
        <div class="flex items-center gap-3 mb-4 pb-4 border-b border-green-100">
            <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-green-600 text-white flex items-center justify-center rounded-xl shadow-md font-semibold">
